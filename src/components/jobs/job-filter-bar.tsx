...
import { cities, jobTypes, industries } from "./data";
      ...
      <div className="flex flex-wrap gap-1.5">
        {items.map((item) => (
          <Button
            ...
            className={
              active === item.value
                ? "rounded-full bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/25 shadow-sm shadow-emerald-500/10 hover:bg-emerald-500/20"
                : "rounded-full text-[var(--ism-fg-muted)] hover:border-emerald-500/30 hover:text-emerald-500"
            }
          >
            {item.label}
          </Button>
    ...
    >
      ...
      <div className="relative mb-4">
        ...
        <Input
          ...
          className="h-10 rounded-xl border-white/[0.08] bg-transparent pl-10 text-[var(--ism-fg)] placeholder:text-[var(--ism-fg-muted)]/60 focus-visible:border-emerald-500/40 focus-visible:ring-emerald-500/20"
        />
      </div>
