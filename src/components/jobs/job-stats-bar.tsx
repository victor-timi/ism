...
import { HiBriefcase, HiArrowPath, HiShieldCheck } from "react-icons/hi2";
...
const stats = [
  ...
  },
  {
    icon: HiArrowPath,
    value: "Updated daily",
    label: "fresh listings every morning",
  },
  {
    icon: HiShieldCheck,
    value: "100%",
    label: "visa-compatible",
  },
];
      ...
      <div className="flex flex-col items-center justify-center gap-6 sm:flex-row sm:gap-12 lg:gap-16">
        {stats.map((stat) => (
          <div key={stat.label} className="flex items-center gap-3">
            <stat.icon className="h-5 w-5 shrink-0 text-emerald-500" />
            <div>
